...
@tmp.11 = private unnamed_addr constant [6 x i8] c"Done!\00", align 1
...
entry:
  ...
  %printf56 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @fmt.1, i32 0, i32 0), i8* getelementptr inbounds ([47 x i8], [47 x i8]* @tmp.3, i32 0, i32 0))
  %f57 = load %struct.Matrix*, %struct.Matrix** %f
  %printbig58 = call %struct.Matrix* @display(%struct.Matrix* %f57)
  %printf59 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @fmt.1, i32 0, i32 0), i8* getelementptr inbounds ([47 x i8], [47 x i8]* @tmp.4, i32 0, i32 0))
  %b60 = load %struct.Matrix*, %struct.Matrix** %b
  %printbig61 = call %struct.Matrix* @display(%struct.Matrix* %b60)
  %printf62 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @fmt.1, i32 0, i32 0), i8* getelementptr inbounds ([47 x i8], [47 x i8]* @tmp.5, i32 0, i32 0))
  %c63 = load %struct.Matrix*, %struct.Matrix** %c
  %printbig64 = call %struct.Matrix* @display(%struct.Matrix* %c63)
  %printf65 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @fmt.1, i32 0, i32 0), i8* getelementptr inbounds ([47 x i8], [47 x i8]* @tmp.6, i32 0, i32 0))
  %d66 = load %struct.Matrix*, %struct.Matrix** %d
  %printbig67 = call %struct.Matrix* @display(%struct.Matrix* %d66)
  %printf68 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @fmt.1, i32 0, i32 0), i8* getelementptr inbounds ([47 x i8], [47 x i8]* @tmp.7, i32 0, i32 0))
  %g69 = load %struct.Matrix*, %struct.Matrix** %g
  %printbig70 = call %struct.Matrix* @display(%struct.Matrix* %g69)
  %printf71 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @fmt.1, i32 0, i32 0), i8* getelementptr inbounds ([47 x i8], [47 x i8]* @tmp.8, i32 0, i32 0))
  %h72 = load %struct.Matrix*, %struct.Matrix** %h
  %printbig73 = call %struct.Matrix* @display(%struct.Matrix* %h72)
  %printf74 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @fmt.1, i32 0, i32 0), i8* getelementptr inbounds ([47 x i8], [47 x i8]* @tmp.9, i32 0, i32 0))
  %i75 = load %struct.Matrix*, %struct.Matrix** %i
  %printbig76 = call %struct.Matrix* @display(%struct.Matrix* %i75)
  %printf77 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @fmt.1, i32 0, i32 0), i8* getelementptr inbounds ([47 x i8], [47 x i8]* @tmp.10, i32 0, i32 0))
  %printf78 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @fmt.1, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @tmp.11, i32 0, i32 0))
  ret i32 0
}
