...
@tmp.4 = private unnamed_addr constant [6 x i8] c"Done!\00", align 1
...
entry:
  ...
  %init_matrix19 = call %struct.Matrix* @initMatrix(i32 3, i32 4)
  ...
  %store_matrix22 = call %struct.Matrix* @store(%struct.Matrix* %init_matrix19, i32 3)
  %store_matrix23 = call %struct.Matrix* @store(%struct.Matrix* %init_matrix19, i32 4)
  ...
  %store_matrix26 = call %struct.Matrix* @store(%struct.Matrix* %init_matrix19, i32 2)
  %store_matrix27 = call %struct.Matrix* @store(%struct.Matrix* %init_matrix19, i32 3)
  %store_matrix28 = call %struct.Matrix* @store(%struct.Matrix* %init_matrix19, i32 7)
  %store_matrix29 = call %struct.Matrix* @store(%struct.Matrix* %init_matrix19, i32 5)
  %store_matrix30 = call %struct.Matrix* @store(%struct.Matrix* %init_matrix19, i32 2)
  %store_matrix31 = call %struct.Matrix* @store(%struct.Matrix* %init_matrix19, i32 3)
  store %struct.Matrix* %init_matrix19, %struct.Matrix** %f
  %m32 = load %struct.Matrix*, %struct.Matrix** %m
  %transpose = call %struct.Matrix* @transpose(%struct.Matrix* %m32)
  store %struct.Matrix* %transpose, %struct.Matrix** %m
  %m33 = load %struct.Matrix*, %struct.Matrix** %m
  %printbig = call %struct.Matrix* @display(%struct.Matrix* %m33)
  ...
  %n34 = load %struct.Matrix*, %struct.Matrix** %n
  %printbig35 = call %struct.Matrix* @display(%struct.Matrix* %n34)
  %printf36 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @fmt.1, i32 0, i32 0), i8* getelementptr inbounds ([47 x i8], [47 x i8]* @tmp.3, i32 0, i32 0))
  %f37 = load %struct.Matrix*, %struct.Matrix** %f
  %printbig38 = call %struct.Matrix* @display(%struct.Matrix* %f37)
  %printf39 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @fmt.1, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @tmp.4, i32 0, i32 0))
  ret i32 0
}
